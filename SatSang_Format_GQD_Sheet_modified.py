...
print("SatsTemp1Bhushan.csv             CRIS IMPORTABLE SATSANG FORMAT  :: output_folder_path")
...
# input path GQD_Schedule_04thJuly20_WorkInProgress # changed to GQD-current-export-withoutStationCodes.csv
...
# gqd_df = pd.read_csv(inputPath + 'GQD_Schedule_04thJuly20_WorkInProgress.csv')
gqd_df = pd.read_csv(inputPath + 'GQD-current-export-withoutStationCodes.csv') # GQD dataframe
...
# data_frame.to_csv(postprocessPath+'SatSang_Format.csv') # originally by Bhushan
data_frame.to_csv(postprocessPath+'SatsTemp1Bhushan.csv')
